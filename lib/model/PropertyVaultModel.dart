...
// To parse this JSON data, do
//
//     final propertyVaultModel = propertyVaultModelFromJson(jsonString);

import 'dart:convert';

PropertyVaultModel propertyVaultModelFromJson(String str) => PropertyVaultModel.fromJson(json.decode(str));

String propertyVaultModelToJson(PropertyVaultModel data) => json.encode(data.toJson());

class PropertyVaultModel {
  PropertyVaultModel({
    this.status,
    this.data,
  });
  ...
  factory PropertyVaultModel.fromJson(Map<String, dynamic> json) => PropertyVaultModel(
    status: json["status"],
