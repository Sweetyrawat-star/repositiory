...
import 'package:swiftasset/model/destribute.dart';
...
class _DistributePageState extends State<DistributePage> {
  ...
  Future<List<Datum>> fetchSummary() async {
    ...
    final response = await http
        .get('http://dev.swiftassets.net/public/api/distribute/all', headers: {
  ...
  Future<GetDistribute> getDistribute() async {
    try {
      ...
      print("token" + "$store1");
      var header = "Bearer $store1";
      final url = "http://dev.swiftassets.net/public/api/distribute/all";
      ...
      if (response.statusCode == 200) {
        ...
        return GetDistribute.fromJson(getProduct);
      } else {}
    } catch (e) {
      print("catch error");
    }
    return GetDistribute();
  }
