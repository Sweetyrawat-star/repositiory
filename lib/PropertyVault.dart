...
class PropertyVaultPage extends StatefulWidget {
  @override
  _PropertyVaultPageState createState() => _PropertyVaultPageState();
}

class _PropertyVaultPageState extends State<PropertyVaultPage> {
  ...
  Future<List<Result>> fetchSummary() async {
    ...
    final response = await http
        .get('http://dev.swiftassets.net/public/api/property_vault', headers: {
            ...
            child: ListView(children: <Widget>[
              Column(children: <Widget>[
                ...
                Container(
                    height: MediaQuery.of(context).size.height,
                    child: FutureBuilder(
                      future: APIService.getPropertyVault(),
                      builder: (BuildContext context,
                          AsyncSnapshot<PropertyVaultModel> snapshot) {
                        if (snapshot.hasData) {
                          return Stack(
                            fit: StackFit.expand,
                            children: [
                            ...
                            .map(
                              (country) => DataRow(
                                cells: [
                                  ...
                                  DataCell(
                                    Center(
                                      child: country.transactionType.toString()!= null? Text(
