...
import 'package:swiftasset/model/IndirectDistributeModel.dart';
import 'package:swiftasset/sharedpreference/store.dart';
import 'package:http/http.dart' as http;

class IndirectPage extends StatefulWidget {
  @override
  _IndirectPageState createState() => _IndirectPageState();
}

class _IndirectPageState extends State<IndirectPage> {
  ...
  Future<List<Datum>> fetchSummary() async {
    ...
    final response = await http.get(
        'http://dev.swiftassets.net/public/api/distribute/indirect',
        headers: {
  ...
  Future<IndirectDistributeModel> getDistribute() async {
    try {
      ...
      print("token" + "$store1");
      var header = "Bearer $store1";
      final url = "http://dev.swiftassets.net/public/api/distribute/indirect";
      ...
      if (response.statusCode == 200) {
        ...
        return IndirectDistributeModel.fromJson(getProduct);
      } else {}
    } catch (e) {
      print("catch error");
    }
    return IndirectDistributeModel();
  }
